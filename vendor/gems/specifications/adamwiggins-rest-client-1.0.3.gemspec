...
Gem::Specification.new do |s|
  s.name = %q{adamwiggins-rest-client}
  s.version = "1.0.3"
  ...
  s.test_files = ["spec/base.rb", "spec/exceptions_spec.rb", "spec/mixin/response_spec.rb", "spec/raw_response_spec.rb", "spec/request_spec.rb", "spec/resource_spec.rb", "spec/response_spec.rb", "spec/restclient_spec.rb"]
